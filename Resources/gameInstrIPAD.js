...
var gameinstructionsIPAD = Ti.UI.createWindow
	({
	...
	gameinstructionsIPAD.orientationModes = [Ti.UI.LANDSCAPE_LEFT,Ti.UI.LANDSCAPE_RIGHT];
...
// 	
	...
	// gameinstructionsIPAD.add(background);
// 
...
var topBanner = Ti.UI.createImageView
	...
	gameinstructionsIPAD.add(topBanner);



var textAreaInstructionsIpad = Titanium.UI.createTextArea({
	...
	gameinstructionsIPAD.add(textAreaInstructionsIpad);
...
{
	gameinstructionsIPAD.close();
	winLinearIPAD.close();
	winIPAD.open();
	winRelativeIPAD.open();

});
gameinstructionsIPAD.add(b1);
