...
//Game Logic:
	...
	myImages[0] = "images/block1.jpg";
	myImages[1] = "images/block2.jpg";
	myImages[2] = "images/block3.jpg";
	
	
	var image1, image2, image3;
	
	var correct1 = "images/block1.jpg";
	var correct2 = "images/block2.jpg";
	var correct3 = "images/block3.jpg";
...
// 		
			// //add video to screen
			// playGameDROID.add(activeMovie);
// 	
		  	// //autoReward(); 
			// activeMovie.play();
// 			
			// setTimeout(function(){
			  // playGameDROID.remove(activeMovie);
			// }, 5000);
// 
// 
			// }, 500);
...
function randomImages()
{
	...
	rewardB.addEventListener('click', function()
	{
			...
			//add video to screen
			playGameDROID.add(activeMovie2);
			...
			setTimeout(function(){
			 	...
			 	playGameDROID.remove(activeMovie2);
