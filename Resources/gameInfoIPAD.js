...
var gameinformationIPAD = Ti.UI.createWindow
	({
	...
	gameinformationIPAD.orientationModes = [Ti.UI.LANDSCAPE_LEFT,Ti.UI.LANDSCAPE_RIGHT];
...
var background = Ti.UI.createImageView
	...
	gameinformationIPAD.add(background);
...
var topBanner = Ti.UI.createImageView
	...
	gameinformationIPAD.add(topBanner);
...
gameinformationIPAD.add(middle1);
...
gameinformationIPAD.add(middle2);
...
gameinformationIPAD.add(middle3);
...
gameinformationIPAD.add(middle4);
...
gameinformationIPAD.add(middle5);
...
gameinformationIPAD.add(creditLabel);
...
{
	gameinformationIPAD.close();
	winLinearIPAD.close();
	winIPAD.open();
	winRelativeIPAD.open();
});
gameinformationIPAD.add(b1);
