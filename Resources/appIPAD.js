...
Ti.include( 'IPADviewreport.js','gameInfoIPAD.js','gameInstrIPAD.js','playGameIPAD.js','linearIPAD.js','relativeIPAD.js');
...
//Creates button for viewing your game play report
var buttonViewReport = Ti.UI.createButton({
	color: '#000000',
	left:20,
	top:90,
	width:100,
	...
	buttonViewReport.addEventListener('click', function(e)
	{
		winIPADviewreport.open();
		winIPAD.close();
	});
	//Adds button to view
	winIPAD.add(buttonViewReport);
...
var button = Ti.UI.createButton({
	...
	{
		MyGlobalVars.ipadUserName = field.value;
		alert("Hello " + MyGlobalVars.ipadUserName +"!");
	});
...
function openRelative()
{
	...
	//error checking to be used to see if window is open or not
	// if ( typeof winRelativeIPAD == 'undefined' && typeof winLinearIPAD == 'undefined') 
	// { 
			// //Open relative button window if its not open
        	// winRelativeIPAD.open();
    // } 
    // else 
    // {
